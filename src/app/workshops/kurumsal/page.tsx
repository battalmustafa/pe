...
async function getWorkshops() {
  ...
  const res = await fetch(`${baseUrl}/api/workshops?category=kurumsal`, {
    cache: 'no-store',
    headers: {
...
export default async function KurumsalWorkshopsPage() {
    ...
    <div className="container mx-auto py-12 px-4 sm:px-6 lg:px-8">
      <div className="text-center mb-12">
        <h1 className="text-4xl md:text-5xl font-bold mb-6">
          <span className="title-gradient">Kurumsal Atölyeler</span>
        </h1>
      </div>
    ...
    <Card className="h-full flex flex-col overflow-hidden hover:shadow-md transition-shadow">
      ...
      <CardHeader>
        <div className="flex flex-wrap gap-2 mb-2">
          <Badge className="self-start">Kurumsal</Badge>
          {workshop.status && (
